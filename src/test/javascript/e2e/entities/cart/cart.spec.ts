...
describe('Cart e2e test', () => {
  ...
  it('should load Carts', async () => {
    ...
    expect(await cartComponentsPage.getTitle()).to.eq('gatewayApp.cart.home.title');
  ...
  it('should load create Cart page', async () => {
    ...
    expect(await cartUpdatePage.getPageTitle()).to.eq('gatewayApp.cart.home.createOrEditLabel');
  ...
  it('should delete last Cart', async () => {
    ...
    expect(await cartDeleteDialog.getDialogTitle()).to.eq('gatewayApp.cart.delete.question');
